    ...
    public static void main(String[] args) {
        ...
        /*
           ...
           import java.util.List;
             ...
             Bir listedeki tüm elementleri iterator kullanarak silin.
              public static void main(String[] args) {
            ...
            Iterator<String> li1 = liste.listIterator();

            while (li1.hasNext()) {   // TRUE
                li1.next();           // ARAYA GİRİP HEP BİR YANINDAKİNİ YAZDIRACAK
                li1.remove();         // NEXT İN YAZDIRDIGINI BİR BİR SİLECEK
